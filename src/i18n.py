...
TRANSLATIONS = {
    "en": {
        ...
        "dify_dataset_label": "Target dataset (knowledge base)",
    ...
    "ko": {
        ...
        "dify_connect_button": "🔗 연결 확인 및 데이터셋 불러오기",
        "dify_connecting": "연결 중...",
        "dify_connected": "✅ 연결 성공",
        "dify_connect_failed": "❌ 연결 실패: {error}",
        "dify_dataset_label": "저장할 데이터셋 (지식 베이스)",
        "dify_dataset_placeholder": "데이터셋을 선택하세요",
        "dify_no_datasets": "데이터셋이 없습니다. Dify에서 먼저 지식 베이스를 생성하세요.",
